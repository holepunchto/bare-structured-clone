module.exports = class DataCloneError extends Error {
  ...
  static INVALID_PROPERTY_KEY(msg) {
    return new DataCloneError(msg, 'INVALID_PROPERTY_KEY', DataCloneError.INVALID_PROPERTY_KEY)
  }

  static INVALID_ARRAY_LAYOUT(msg) {
    return new DataCloneError(msg, 'INVALID_ARRAY_LAYOUT', DataCloneError.INVALID_ARRAY_LAYOUT)
  }

  static INVALID_TYPE(msg) {
    return new DataCloneError(msg, 'INVALID_TYPE', DataCloneError.INVALID_TYPE)
  }

  static INVALID_VIEW(msg) {
    return new DataCloneError(msg, 'INVALID_VIEW', DataCloneError.INVALID_VIEW)
  }
}
