...
interface StructuredCloneOptions {
  /** Objects to transfer rather than clone; each is detached from the original after cloning. */
  transfer: TransferableValue[]
  /**
   * Serializable and transferable constructors to recognize when (de)serializing custom platform
   * objects.
   */
 ...
 * @throws {UNSERIALIZABLE_TYPE} `value`, or a value it references, is of a type that cannot be
 ...
 * @throws {INVALID_INTERFACE} a serializable or transferable value has an interface that is not
